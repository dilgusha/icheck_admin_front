...
type NuxtAppInjections = 
  ...
  InjectionType<typeof import("../../node_modules/@bg-dev/nuxt-naiveui/dist/runtime/plugins/colorMode.js")> &
  InjectionType<typeof import("../../node_modules/@bg-dev/nuxt-naiveui/dist/runtime/plugins/naive.server.js")> &
...
declare module '#app' {
  ...
  interface NuxtAppLiterals {
    pluginName: 'nuxt:revive-payload:client' | 'nuxt:head' | 'nuxt:router' | 'session-fetch-plugin' | 'nuxt:browser-devtools-timing' | 'nuxt:revive-payload:server' | 'nuxt:chunk-reload' | 'nuxt:global-components' | 'nuxt:prefetch' | 'nuxt:checkIfPageUnused' | 'i18n:plugin:switch-locale-path-ssr' | 'i18n:plugin:route-locale-detect' | 'i18n:plugin:preload' | 'i18n:dev' | 'i18n:plugin' | 'nuxt:checkIfLayoutUsed' | 'i18n:plugin:ssg-detect'
  }
}
