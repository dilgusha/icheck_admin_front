...
const _inlineRuntimeConfig = {
  ...
  "public": {
    ...
    "apiBase": "https://icheckapi.200soft.com/api/v1",
    "auth": {
...
var common = {
	...
	deleteConfirm: "Bu məlumatı silmək istədiyinizə əminsiniz?",
	updated: "Məlumat yeniləndi",
	created: "Məlumat yaradıldı",
	deleted: "Məlumat silindi",
	startsAt: "Başlama vaxtı",
	endsAt: "Bitmə vaxtı",
	region: "Region",
	address: "Ünvan",
	titleRequired: "3 dildə ad daxil edin",
	requiredFields: "Bütün tələb olunan xanaları doldurun",
	details: "Ətraflı məlumat",
	close: "Bağla"
};
var ads = {
	title: "Reklamlar",
	description: "Səhiyyə şəbəkəsində reklamları idarə edin.",
	create: "Reklam yarat",
	titlePlaceholder: "Reklam başlığı...",
	body: "Reklam məzmunu",
	bodyPlaceholder: "Reklam məzmunu...",
	buttonText: "Düymə mətn",
	link: "Reklam linki",
	image: "Şəkil",
	placement: "Yerləşdirmə",
	sortOrder: "Sıralama",
	buttonTextPlaceholder: "Düymə mətn...",
...
var doctors = {
	title: "Həkimlər",
	description: "Səhiyyə şəbəkəsində həkimləri idarə edin.",
	create: "Həkim yarat",
...
const login_post = defineEventHandler(async (event) => {
  ...
  try {
    const tokens = await $fetch("https://icheckapi.200soft.com/auth/login/", {
      method: "POST",
    ...
    throw createError({
      statusCode: ((_c = err == null ? void 0 : err.response) == null ? void 0 : _c.status) || 401,
      statusMessage: ((_d = err == null ? void 0 : err.data) == null ? void 0 : _d.detail) || "Incorrect username or password."
    });
  }
});
